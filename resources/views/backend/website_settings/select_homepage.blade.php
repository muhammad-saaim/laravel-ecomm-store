				...
				<div class="row">
					...
					<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center">
							<span class="fs-14 fw-500 text-dark">{{ translate('inicio 1') }}</span>
							<span>
					...
					<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center">
							<span class="fs-14 fw-500 text-dark">{{ translate('inicio 2') }}</span>
							<span>
								<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
					...
					<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center">
							<span class="fs-14 fw-500 text-dark">{{ translate('inicio 3') }}</span>
							<span>
								<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
					...
					<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center">
							<span class="fs-14 fw-500 text-dark">{{ translate('inicio 4') }}</span>
							<span>
								<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
					...
					<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center">
							<span class="fs-14 fw-500 text-dark">{{ translate('inicio 5') }}</span>
							<span>
								<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
